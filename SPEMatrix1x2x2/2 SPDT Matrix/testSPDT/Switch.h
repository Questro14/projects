...
class Switch {
  public:
    ...
    DataBlock SwBlock[10] = {{2, 2, 0x02, 5,  {0x00, 0x01, 0x02}},
      {6, 8, 0x80, 5,  {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
      
      {2, 2, 0x02, 6, {0x00, 0x01, 0x02}}, //h11
      {2, 2, 0x02, 6, {0x00, 0x01, 0x02}}, //h12

      {4, 4, 0x08, 5, {0x00, 0x00, 0x00, 0x00, 0x00}},

      {2, 2, 0x02, 7, {0x00, 0x01, 0x02}},//h13
      {2, 2, 0x02, 7, {0x00, 0x01, 0x02}},//h14

      {4, 4, 0x08, 5, {0x00, 0x00, 0x00, 0x00,0x00}},

      {2, 2, 0x02, 4, {0x00, 0x01, 0x02}},//h15
      {2, 2, 0x02, 4, {0x00, 0x01, 0x02}},//h16
    };
    void Init(void);
