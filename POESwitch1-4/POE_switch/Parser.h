...
const PROGMEM char CMD_STATE_SWITCH1[] = "STATE:SWITCH1,1";
const PROGMEM char CMD_STATE_SWITCH2[] = "STATE:SWITCH1,2";
const PROGMEM char CMD_STATE_SWITCH3[] = "STATE:SWITCH1,3";
const PROGMEM char CMD_STATE_SWITCH4[] = "STATE:SWITCH1,4";
const PROGMEM char REQ_STATE_SWITCH[] = "STATE:SWITCH?";
