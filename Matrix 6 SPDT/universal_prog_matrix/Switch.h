...
class Switch {
  public:
    ...
    DataBlock SwBlock436[11] = {{6, 8, 0x80, 5,  {0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20}},
    ...
    DataBlock SwBlockSPDT[7] = {{ 2, 2, 0x02, 4,  {0x00, 0x01, 0x02}},
    ...
    void Init(void);
    void UpdateSwitchSPDT(void);
    void UpdateSwitch436(void);
